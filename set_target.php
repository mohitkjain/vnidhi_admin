            ...
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="User Type" disabled>
                </div>
                <div class="form-group">
                    <label>Target of Previous Month:</label>
                    <input type="text" class="form-control" placeholder="Target of Previous Month" disabled>
                </div>
                <div class="form-group">
                    <label>Target Achiceved of Previous Month:</label>
                    <input type="text" class="form-control" placeholder="Target Achiceved of Previous Month" disabled>
                </div>
                <div class="form-group">
                    <label>Set Target for Current Month:*</label>
                    <input type="text" class="form-control" placeholder="Set Target for Current Month">
                </div>
              </div>
              <!-- /.box-body -->
			<div class="form-group">
