...
<?php require 'include/sidebar.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Change Rewards</h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
		<li><a href="#">Rewards</a></li>
        <li class="active">Change Rewards</li>
      </ol>
    </section>
            ...
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" placeholder="Select Year Wise Rewards" style="width: 100%;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Set Rewards(%)">
                </div>
              </div>
              <!-- /.box-body -->
			<div class="form-group">
